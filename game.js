...
(function () {
  ...
  // 레벨별 반지름 비율(보드 너비 기준).
  // 보드 비율은 7.2:8 (높이 ≈ 너비 × 1.111), 게임오버 선은 높이의 0.16 지점.
  // 최종 11단계: 지름 = 보드 너비의 0.5 (반지름 비율 0.25).
  //   → 가장 큰 고양이 2마리가 바닥에 나란히 들어가고(선 아래),
  //     3마리째가 그 위 골에 얹히면 윗부분이 게임오버 선을 살짝 넘어 게임오버됨.
  //   나머지 단계는 1→11 을 매끄럽게 잇는 등비(약 1.108배) 진행.
  const RADIUS_FACTOR = {
    1: 0.090, 2: 0.100, 3: 0.110, 4: 0.122, 5: 0.135, 6: 0.150,
    7: 0.166, 8: 0.184, 9: 0.204, 10: 0.226, 11: 0.250,
  };
